...
public void DeadWait(long milliseconds)  {
    try {
...
public void closeBrowser() {
	...
	public void waitForElementClickable(WebElement element,int timeOutSeconds) {
		new WebDriverWait(driver,Duration.ofSeconds(timeOutSeconds)).until(ExpectedConditions.elementToBeClickable(element));
	}
	...
	public void waitForUrlContains(String urlFraction,int timeOutSeconds) {
		new WebDriverWait(driver,Duration.ofSeconds(timeOutSeconds)).until(ExpectedConditions.urlContains(urlFraction));
	}
